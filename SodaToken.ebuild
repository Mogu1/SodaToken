...
HOMEPAGE="https://sodatoken.org/"

if [[ ${PV} == "9999" ]] ; then
	inherit multiprocessing git-r3
	EGIT_REPO_URI="https://github.com/BinaryOmen/SodaToken/SodaToken.git"
	KEYWORDS=""
else
	inherit multiprocessing
	SRC_URI="https://github.com/BinaryOmen/SodaToken/SodaToken.git"
	RESTRICT="mirror"
	KEYWORDS="~amd64 ~x86"
	S=${WORKDIR}/${P}
fi
