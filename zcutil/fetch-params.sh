...
SPROUT_PKEY_URL="https://sodatoken.org/downloads/$SPROUT_PKEY_NAME"
SPROUT_VKEY_URL="https://sodatoken.org/downloads/$SPROUT_VKEY_NAME"
...
Soda Token uses the same zkSNARK parameters generated by ZCash.
