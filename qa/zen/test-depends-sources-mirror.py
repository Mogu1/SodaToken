...
# contains all of the packages required to build this version of Soda Token.
#
# This script assumes you've just built Soda Token, and that as a result of that
