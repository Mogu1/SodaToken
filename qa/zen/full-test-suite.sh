#!/bin/bash
#
# Execute all of the automated tests related to Soda Token.
#
...
# Test phases:
run_test_phase "${REPOROOT}/qa/sodatoken/check-security-hardening.sh"
run_test_phase "${REPOROOT}/qa/sodatoken/ensure-no-dot-so-in-depends.py"
