...
#   'pruning.py'                # disabled for Soda Token. Failed because of the issue #1302 in zcash
    'forknotify.py'
#   'hardforkdetection.py'      # disabled for Soda Token. Failed because of the issue #1302 in zcash
#   'invalidateblock.py'        # disabled for Soda Token. Failed because of the issue #1302 in zcash
    'keypool.py'
    'receivedby.py'
    'rpcbind_test.py'
