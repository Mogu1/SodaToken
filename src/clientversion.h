...
// Copyright (c) 2018 Binary Omen Foundation
...
#define COPYRIGHT_STR "2009-" STRINGIZE(COPYRIGHT_YEAR) " The Bitcoin Core Developers, The Zcash developers, and Soda Token Blockchain Foundation"
